...
- **Download from Google Drive** [https://drive.google.com/drive/folders/1KznvlzEWtO9sUUro_yWfJw0oKEQAQoHB?usp=sharing](Here)

The dataset includes:
- `elk-drawing.hdr` - ENVI header file
- `elk-drawing.png` - Preview image 
- `elk-drawing.raw` - Raw hyperspectral data 
